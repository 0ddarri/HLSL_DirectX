...
void RenderScene()
{
	...
	gpSpecularShader->SetMatrix("gViewMatrix", &matView);
	gpSpecularShader->SetMatrix("gProjectionMatrix", &matProjection);
...
bool LoadAssets()
{
	...
	// 쉐이더 로딩
	gpSpecularShader = LoadShader("Resources/Shader/specularmapping.fx");
